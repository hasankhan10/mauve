...
function Navbar() {
  return (
    <div className='navbar absolute w-[100%] h-[50px] top-7 flex justify-start pl-16 space-x-96 z-50'>
        <nav className='logo h-full w-fit'>
        ...
        <nav className=' h-full w-[43%] backdrop:blur-3xl rounded-lg overflow-hidden flex justify-center shadow-lg shadow-gray-500 hover:shadow-gray-600 duration-200'>
