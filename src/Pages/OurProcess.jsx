...
function OurProcess() {
  return (
    <div className="ourProcess w-screen h-screen flex justify-center place-items-center sm:space-x-10 sm:pt-10">
        <motion.section animate={{y:0,opacity:1}} initial={{y:100,opacity:0}} transition={{duration:2}} className="pic hidden sm:block w-[40%] h-[80%] overflow-hidden rounded-2xl">
            <img className=" w-full h-full" src="https://i.pinimg.com/564x/99/54/8a/99548af51d74f323b630a15621d78599.jpg" alt="" />
        </motion.section>
        <motion.section animate={{y:0}} initial={{y:-100}} transition={{duration:1}} className=" sm:w-[45%] sm:h-[80%] z-30 backdrop-blur-2xl flex flex-col gap-10 justify-center place-items-center rounded-xl p-2">
            <h1 className="text-center sm:text-6xl text-3xl font-bold text-white">OUR METHODOLOGY</h1>
